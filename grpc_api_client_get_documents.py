...
# Шаг 3. Получаем документ тарифа
...
# Шаг 4. Получаем документ контракта
get_contract_document_response = documents_gateway_client.get_contract_document(account_id=account_id)
